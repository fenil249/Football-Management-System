...
<h1 class="contact">Query</h1>
    <section class="contactus">
        ...
        <form action="sql2.php" method="POST">
                ...
                <label>Attendance</label>
                 <input type="number" name="Attendance" class="form-control"  placeholder="Enter Your Attendance">
                </div>
                <div class="formgrp">
    ...
    <?php
            ...
            $result = $mysqli->query( "SELECT Player_ID,Name,Age,Batch_No,Attendance FROM player_info where Age>='$Age' and Attendance>='$Attendance' Order by Age") or die($mysqli->error);
