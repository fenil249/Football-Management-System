...
<!-- 
 ...
 <!-- <a href="index.php" class="btn btn-primary">home</a>  -->
        ...
        <?php
                ...
                $result = $mysqli->query( "SELECT * FROM super_admin") or die($mysqli->error);
...
<!-- 
 ...
 <h1 class="contact">Super Admin</h1>
    <section class="contactus">
        <div id="contactbox">
        <form action="process4.php" method="POST">
                <div class="formgrp">
                <label>Super Admin ID</label>
                <input type="text" name="Super_Admin_ID" class="form-control"   placeholder="Enter Your Super Admin ID">
                </div>
                <div class="formgrp">
                <label>Name</label>
...
<div class="justify-content-center">
            ...
            ?>
                    <tr>
                        <td><?php echo $row['Super_Admin_ID']; ?></td>
                        <td><?php echo $row['Name']; ?></td>
                        <td><?php echo $row['Contact_No']; ?></td>
                        <td><?php echo $row['Email_ID']; ?></td>
                        <td>
                            
                            <a href="process4.php?delete=<?php echo $row['Super_Admin_ID']; ?>"
