...
<!-- 
 ...
 <!-- <a href="index.php" class="btn btn-primary">home</a>  -->
        ...
        <?php
                ...
                $result = $mysqli->query( "SELECT * FROM trainer_info") or die($mysqli->error);
...
<!-- 
 ...
 <h1 class="contact">Trainer</h1>
    <section class="contactus">
        <div id="contactbox">
        <form action="process3.php" method="POST">
                <div class="formgrp">
                <label>Trainer ID</label>
                <input type="text" name="Trainer_ID" class="form-control"   placeholder="Enter Your Trainer ID">
                </div>
                <div class="formgrp">
                <label>Name</label>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="process3.php?delete=<?php echo $row['Trainer_ID']; ?>"
